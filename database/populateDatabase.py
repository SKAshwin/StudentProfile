...
opts, vals = getopt.getopt(args, 's:d:t:h', ['skip=','db=','database=','table=','help'])
...
for line in open(datasource):
    ...
    if line!='\n':
        ...
        query = "INSERT INTO {} VALUES({},{})".format(table,code,mc)
        print(query)
        conn.execute("INSERT INTO {} VALUES(?,?)".format(table), (code,mc))
conn.commit()       
